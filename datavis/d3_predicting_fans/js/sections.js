...
//	document.getElementById("#vis").style.display = inline;
	...
	g.selectAll('.bar_pca_init')
	    .transition()
	    .duration(1000)
	    .attr("cx", function(d) { return d.bet_mean < 3 ? xChart_pca(0) : xChart_pca(10);})//xChart_pca(d.x); })
	    .attr("cy", function(d) { return height;})//yChart_pca(d.y); })
	    .attr('opacity', 1.0);	
